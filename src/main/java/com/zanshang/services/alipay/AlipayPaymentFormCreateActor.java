 ...
 */
public abstract class AlipayPaymentFormCreateActor extends BaseUntypedActor {
    ...
    public AlipayPaymentFormCreateActor(ApplicationContext spring) {
        super(spring);
    ...
    public void onReceive(Object o) throws Exception {
        ...
        paymentAsk.onSuccess(new OnSuccess<Object>() {
            ...
            public void onSuccess(Object o) throws Throwable {
                ...
                orderMap.put("service", getService());
                ...
                orderMap.put("return_url", REQUEST_CONTEXT + parameters.getRequestContext() +
                        AlipayController.ALIPAY_PATH + AlipayController.RETURN_FORM_PATH);
                ...
                long cents = price.getUnit().toCent(price.getPrice());
