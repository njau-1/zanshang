 ...
 */
public class AuthorVerifiedActor extends BaseUntypedActor {

    ActorRef personActor;

    ActorRef companyActor;

    public AuthorVerifiedActor(ApplicationContext spring) {
        super(spring);
...
//                    } else {
                        AuthorInformationIndexByIdentity byIdentity = getMongoTemplate().findById(information
                                .getIdentityCode(), AuthorInformationIndexByIdentity.class);
