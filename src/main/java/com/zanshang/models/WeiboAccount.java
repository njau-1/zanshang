 ...
 */
@Document(collection = "weibo_accounts")
public class WeiboAccount implements UserDetails, ZSAccount {
    ...
    public WeiboAccount(ObjectId uid, String openId) {
        this.uid = uid;
    ...
    public WeiboAccount(ObjectId uid, UserAuthorities authorities, String username, boolean nonExpired, boolean
    ...
    public boolean equals(Object o) {
        ...
        WeiboAccount that = (WeiboAccount) o;
