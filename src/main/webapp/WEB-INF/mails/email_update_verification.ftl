                ...
                <table width="100%;">
                    ...
                    <tr>
                        <td style="color:#5c5c5c; font-size:16px; line-height:26px;">
                            您进行了『修改邮箱』操作，请点击下面的链接完成验证：
                        </td>
                    </tr>
                    <tr>
                        <td style="color:#5c5c5c; font-size:16px; line-height:26px;">
                            <a href="http://www.zan-shang.com/settings/mails/activation?email=${email?url("utf-8")}&code=${code}">www.zan-shang.com/settings/mails/activation?email=${email?url("utf-8")}&code=${code}</a>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td width="33%" style="text-align: center; width: 33%;">
                                        <a href="mailto:service@zan-shang.com">
                                            <img src="${requestContext.contextPath}/static/img/email.png" height="75"
                                                 alt="邮箱：service@zan-shang.com"/></a>
