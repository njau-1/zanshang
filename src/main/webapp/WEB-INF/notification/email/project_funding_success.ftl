                ...
                <table width="100%;">
                    ...
                    <tr>
                        <td style="color:#5c5c5c; font-size:16px; line-height:26px;">
                            恭喜，您的项目
                            <a href="http://www.zan-shang.com/projects/${projectId}">《${bookName}》</a>
                            已筹款成功，请再接再厉继续推广，并请确保在本书赞赏截止日(${deadLine})前完成书稿哦!
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">
                            <a href="http://www.zan-shang.com/projects/${projectId}">
                                <img src="${cover}" width="140" height="200" alt="${bookName}" style="-webkit-box-shadow: 0 0 10px #e5e5e5;
                                        box-shadow: 0 0 10px #e5e5e5; border: 0;" /></a>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center; padding-top: 10px; font-size: 14px;">
                            <a href="http://www.zan-shang.com/projects/${projectId}">项目详情</a>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
