                ...
                <table width="100%;">
                    ...
                    <tr>
                        <td style="color:#5c5c5c; font-size:16px; line-height:26px;">
                            <a href="http://www.zan-shang.com/salons/${uid}">《${bookName}》</a>
                            项目作者${author}在沙龙中更新了样稿,欢迎留言讨论.
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">
                            <a href="http://www.zan-shang.com/salons/${uid}">
                    ...
                    <tr>
                        <td style="text-align: center; padding-top: 10px; font-size: 14px;">
                            <a href="http://www.zan-shang.com/salons/${uid}">进入沙龙</a>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
