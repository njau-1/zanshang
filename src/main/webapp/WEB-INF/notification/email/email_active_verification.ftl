        ...
        <tr>
            <td style="background-color: #fff;  padding:30px; padding-bottom:20px; border-radius: 4px;">
                <table width="100%;">
                    ...
                    <tr>
                        <td style="color:#5c5c5c; font-size:16px; line-height:26px;">
                            <a href="http://www.zan-shang.com/account/mails/activate?email=${email?url("utf-8")}&code=${code}">www.zan-shang.com/account/mails/activate?email=${email?url("utf-8")}&code=${code}</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="color:#5c5c5c; font-size:16px; line-height:26px;">
